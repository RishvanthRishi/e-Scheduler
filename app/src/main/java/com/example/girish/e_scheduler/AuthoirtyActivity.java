...
public class AuthoirtyActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_authoirty);
    }
    public void schedule(View view)
    {
        ...
        if(box1.isChecked())
        {
            mes1= "Problems under SAC";
        }
        else if(box2.isChecked())
        {
            mes1= "TIIC lab issues";
        }
        else if (other!=null)
        {
            mes1 = other;
        ...
        if((box1.isChecked()||box2.isChecked())|| other!=null) {
            ...
            inten.putExtra(Intent.EXTRA_EMAIL, new String[]{"profanurag@gmail.com"});
