...
public class Tapaswi extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tapaswi);
    }
    public void schedule(View view)
    {
        ...
        if(box1.isChecked())
        {
            mes1= "Webmail related issues";
        }
        else if(box2.isChecked())
        {
            mes1= "Academic Problems";
        }
        ...
        if((box1.isChecked()||box2.isChecked())|| other!=null) {
            ...
            inten.putExtra(Intent.EXTRA_EMAIL, new String[]{"stapaswi@gmail.com"});
