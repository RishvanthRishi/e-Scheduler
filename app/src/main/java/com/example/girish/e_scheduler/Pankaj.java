...
public class Pankaj extends AppCompatActivity  {
    ...
    public void schedule(View view)
    {
        ...
        if(box1.isChecked())
        {
            mes1= "Certificate issuing";
        }
        else if(box2.isChecked())
        {
            mes1= "Scholarship issues";
        }
        ...
        if((box1.isChecked()||box2.isChecked())|| other!=null) {
            ...
            inten.putExtra(Intent.EXTRA_EMAIL, new String[]{"pankajgupta@gmail.com"});
